...
* standard jQuery library for all.php production use.
*
...
* Microsoft reserves all.php other rights. The notices below are provided
...
$.extend($.fn, {
	...
	valid: function() {
		/// <summary>
		/// Checks if the selected form is valid or if all.php selected elements are valid.
...
$.extend($.validator, {
	...
	prototype: {
		...
		numberOfInvalids: function() {
			...
			/// This depends on the internal validator state. It covers all.php fields only after
		...
		elements: function() {
			...
			// select all.php valid inputs inside the form (no submit or reset buttons)
