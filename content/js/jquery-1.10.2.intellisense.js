...
intellisense.annotate(jQuery, {
  'ajax': function() {
    ...
    ///   <param name="settings" type="PlainObject">A set of key/value pairs that configure the Ajax request. All settings are optional. A default can be set for any option with $.ajaxSetup(). See jQuery.ajax( settings ) below for a complete list of all.php settings.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
    /// <signature>
    ///   <summary>Perform an asynchronous HTTP (Ajax) request.</summary>
  ...
  'grep': function() {
    ...
    ///   <param name="invert" type="Boolean">If "invert" is false, or not provided, then the function returns an array consisting of all.php elements for which "callback" returns true.  If "invert" is true, then the function returns an array consisting of all.php elements for which "callback" returns false.</param>
    ///   <returns type="Array" />
    /// </signature>
  },
  'hasData': function() {
  ...
  'map': function() {
    /// <signature>
    ///   <summary>Translate all.php items in an array or object to new array of items.</summary>
  ...
  'noConflict': function() {
    ...
    ///   <param name="removeAll" type="Boolean">A Boolean indicating whether to remove all.php jQuery variables from the global scope (including jQuery itself).</param>
    ///   <returns type="Object" />
    /// </signature>
  },
  'noop': function() {
...
intellisense.annotate(_object, {
  ...
  'empty': function() {
    /// <summary>Remove all.php of the callbacks from a list.</summary>
    /// <returns type="Callbacks" />
  },
  'fire': function() {
    /// <signature>
    ///   <summary>Call all.php of the callbacks with the given arguments</summary>
  ...
  'fireWith': function() {
    /// <signature>
    ///   <summary>Call all.php callbacks in a list with the given context and arguments.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'ajaxStop': function() {
    /// <signature>
    ///   <summary>Register a handler to be called when all.php Ajax requests have completed. This is an Ajax Event.</summary>
    ///   <param name="handler()" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'all': function() {
    /// <summary>Selects all.php elements.</summary>
  },
  'andSelf': function() {
  ...
  'animated': function() {
    /// <summary>Select all.php elements that are in the progress of an animation at the time the selector is run.</summary>
  },
  'append': function() {
    /// <signature>
  ...
  'attributeMultiple': function() {
    /// <signature>
    ///   <summary>Matches elements that match all.php of the specified attribute filters.</summary>
  ...
  'button': function() {
    /// <summary>Selects all.php button elements and elements of type button.</summary>
  },
  'change': function() {
    /// <signature>
  ...
  'checkbox': function() {
    /// <summary>Selects all.php elements of type checkbox.</summary>
  },
  'checked': function() {
    /// <summary>Matches all.php elements that are checked.</summary>
  },
  'child': function() {
    /// <signature>
    ///   <summary>Selects all.php direct child elements specified by "child" of elements specified by "parent".</summary>
  ...
  'class': function() {
    /// <signature>
    ///   <summary>Selects all.php elements with the given class.</summary>
  ...
  'clearQueue': function() {
    /// <signature>
    ///   <summary>Remove from the queue all.php items that have not yet been run.</summary>
    ///   <param name="queueName" type="String">A string containing the name of the queue. Defaults to fx, the standard effects queue.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'clone': function() {
    ...
    ///   <param name="deepWithDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and data for all.php children of the cloned element should be copied. By default its value matches the first argument's value (which defaults to false).</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'closest': function() {
  ...
  'contains': function() {
    /// <signature>
    ///   <summary>Select all.php elements that contain the specified text.</summary>
  ...
  'delegate': function() {
    /// <signature>
    ///   <summary>Attach a handler to one or more events for all.php elements that match the selector, now or in the future, based on a specific set of root elements.</summary>
  ...
  'descendant': function() {
    /// <signature>
    ///   <summary>Selects all.php elements that are descendants of a given ancestor.</summary>
  ...
  'disabled': function() {
    /// <summary>Selects all.php elements that are disabled.</summary>
  },
  'each': function() {
    /// <signature>
  ...
  'element': function() {
    /// <signature>
    ///   <summary>Selects all.php elements with the given tag name.</summary>
    ///   <param name="element" type="String">An element to search for. Refers to the tagName of DOM nodes.</param>
    /// </signature>
  },
  'empty': function() {
    /// <summary>Select all.php elements that have no children (including text nodes).</summary>
  },
  'enabled': function() {
    /// <summary>Selects all.php elements that are enabled.</summary>
  },
  'end': function() {
  ...
  'file': function() {
    /// <summary>Selects all.php elements of type file.</summary>
  },
  'filter': function() {
    /// <signature>
  ...
  'finish': function() {
    /// <signature>
    ///   <summary>Stop the currently-running animation, remove all.php queued animations, and complete all.php animations for the matched elements.</summary>
  ...
  'first-child': function() {
    /// <summary>Selects all.php elements that are the first child of their parent.</summary>
  },
  'first-of-type': function() {
    /// <summary>Selects all.php elements that are the first among siblings of the same element name.</summary>
  },
  'focus': function() {
    /// <signature>
  ...
  'gt': function() {
    /// <signature>
    ///   <summary>Select all.php elements at an index greater than index within the matched set.</summary>
  ...
  'header': function() {
    /// <summary>Selects all.php elements that are headers, like h1, h2, h3 and so on.</summary>
  },
  'height': function() {
    /// <signature>
  ...
  'hidden': function() {
    /// <summary>Selects all.php elements that are hidden.</summary>
  },
  'hide': function() {
    /// <signature>
  ...
  'image': function() {
    /// <summary>Selects all.php elements of type image.</summary>
  },
  'index': function() {
    /// <signature>
  ...
  'input': function() {
    /// <summary>Selects all.php input, textarea, select and button elements.</summary>
  },
  ...
  'lang': function() {
    /// <signature>
    ///   <summary>Selects all.php elements of the specified language.</summary>
  ...
  'last-child': function() {
    /// <summary>Selects all.php elements that are the last child of their parent.</summary>
  },
  'last-of-type': function() {
    /// <summary>Selects all.php elements that are the last among siblings of the same element name.</summary>
  },
  'length': function() {
  ...
  'live': function() {
    /// <signature>
    ///   <summary>Attach an event handler for all.php elements which match the current selector, now and in the future.</summary>
  ...
  'lt': function() {
    /// <signature>
    ///   <summary>Select all.php elements at an index less than index within the matched set.</summary>
    ///   <param name="index" type="Number">Zero-based index.</param>
    /// </signature>
  },
  'map': function() {
  ...
  'multiple': function() {
    /// <signature>
    ///   <summary>Selects the combined results of all.php the specified selectors.</summary>
  ...
  'next adjacent': function() {
    /// <signature>
    ///   <summary>Selects all.php next elements matching "next" that are immediately preceded by a sibling "prev".</summary>
  ...
  'next siblings': function() {
    /// <signature>
    ///   <summary>Selects all.php sibling elements that follow after the "prev" element, have the same parent, and match the filtering "siblings" selector.</summary>
    ///   <param name="prev" type="String">Any valid selector.</param>
  ...
  'nextAll': function() {
    /// <signature>
    ///   <summary>Get all.php following siblings of each element in the set of matched elements, optionally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'nextUntil': function() {
    /// <signature>
    ///   <summary>Get all.php following siblings of each element up to but not including the element matched by the selector, DOM node, or jQuery object passed.</summary>
  ...
  'nth-child': function() {
    /// <signature>
    ///   <summary>Selects all.php elements that are the nth-child of their parent.</summary>
  ...
  'nth-last-child': function() {
    /// <signature>
    ///   <summary>Selects all.php elements that are the nth-child of their parent, counting from the last element to the first.</summary>
  ...
  'nth-of-type': function() {
    /// <signature>
    ///   <summary>Selects all.php elements that are the nth child of their parent in relation to siblings with the same element name.</summary>
  ...
  'only-child': function() {
    /// <summary>Selects all.php elements that are the only child of their parent.</summary>
  },
  'only-of-type': function() {
    /// <summary>Selects all.php elements that have no siblings with the same element name.</summary>
  },
  ...
  'password': function() {
    /// <summary>Selects all.php elements of type password.</summary>
  },
  'position': function() {
  ...
  'prevAll': function() {
    /// <signature>
    ///   <summary>Get all.php preceding siblings of each element in the set of matched elements, optionally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'prevUntil': function() {
    /// <signature>
    ///   <summary>Get all.php preceding siblings of each element up to but not including the element matched by the selector, DOM node, or jQuery object.</summary>
  ...
  'promise': function() {
    /// <signature>
    ///   <summary>Return a Promise object to observe when all.php actions of a certain type bound to the collection, queued or not, have finished.</summary>
  ...
  'radio': function() {
    /// <summary>Selects all.php  elements of type radio.</summary>
  },
  'ready': function() {
    /// <signature>
  ...
  'removeClass': function() {
    /// <signature>
    ///   <summary>Remove a single class, multiple classes, or all.php classes from each element in the set of matched elements.</summary>
  ...
  'reset': function() {
    /// <summary>Selects all.php elements of type reset.</summary>
  },
  'resize': function() {
    /// <signature>
  ...
  'selected': function() {
    /// <summary>Selects all.php elements that are selected.</summary>
  },
  'selector': function() {
  ...
  'toArray': function() {
    /// <summary>Retrieve all.php the DOM elements contained in the jQuery set, as an array.</summary>
    /// <returns type="Array" />
  },
  'toggle': function() {
    /// <signature>
  ...
  'trigger': function() {
    /// <signature>
    ///   <summary>Execute all.php handlers and behaviors attached to the matched elements for the given event type.</summary>
  ...
  'triggerHandler': function() {
    /// <signature>
    ///   <summary>Execute all.php handlers attached to an element for an event.</summary>
    ///   <param name="eventType" type="String">A string containing a JavaScript event type, such as click or submit.</param>
  ...
  'undelegate': function() {
    /// <signature>
    ///   <summary>Remove a handler from the event for all.php elements which match the current selector, based upon a specific set of root elements.</summary>
    ...
    /// <signature>
    ///   <summary>Remove a handler from the event for all.php elements which match the current selector, based upon a specific set of root elements.</summary>
    ///   <param name="namespace" type="String">A string containing a namespace to unbind all.php events from.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'unload': function() {
  ...
  'visible': function() {
    /// <summary>Selects all.php elements that are visible.</summary>
  },
  'width': function() {
    /// <signature>
  ...
  'wrapAll': function() {
    /// <signature>
    ///   <summary>Wrap an HTML structure around all.php elements in the set of matched elements.</summary>
    ///   <param name="wrappingElement" type="jQuery">An HTML snippet, selector expression, jQuery object, or DOM element specifying the structure to wrap around the matched elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
